<html>
  ...
  <body>
    <ul class="money1-view view">
      <form action="../../conclude/1" method="POST" name="myform">
        <p>請輸入提款金額：<input name="num2">&nbsp&nbsp<input type="submit" value="Enter" onclick="calculate()"></p>
        <script>
        function calculate(){
